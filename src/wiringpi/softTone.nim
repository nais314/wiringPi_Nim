...
proc softToneCreate* (pin: cint): cint {.importc, header: "softTone.h".}
proc softToneStop*   (pin: cint) {.importc, header: "softTone.h".}
proc softToneWrite*  (pin: cint, freq: cint) {.importc, header: "softTone.h".}
